  ...
  const usersList = users.map((user, index) => {
    if (token !== user.token && role !== 1) {
      ...
      return (
        <tr key={user._id}>
          <th
            onClick={() => isSmallerThan350 && handleUserDropdownClick(index)}
          >
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <S.ButtonToggle onClick={() => handleUserDropdownClick(index)}>
                <S.DropdownIcon visible={user.visible} />
              </S.ButtonToggle>
            </div>
            <S.UserFooter visible={user.visible}>
              <div className="container my-2 p-0">
                <div className="row">
                  <S.Text className="col col-4">Nom</S.Text>
                  <S.Text className="col col-8">
                    {capitalize(user.firstName)} {capitalize(user.lastName)}
                  </S.Text>
                  <S.Text className="col col-4">Email</S.Text>
                  <S.Email
                    className="col col-8"
                    onClick={() =>
                  ...
                  <S.Text className="col col-4">Rôle</S.Text>
                  <S.Text className="col col-8">
            ...
            <tr>
              <S.ThLogin>
                <div
                  ...
                  onClick={() => handleIdDropdownClick()}
                >
                  <span>Identifiant</span>
                  <S.ButtonIdToggle>
                    <S.DropdownIcon visible={isIdAscendant} />
                  </S.ButtonIdToggle>
                </div>
              </S.ThLogin>
              ...
              <S.ThDisplayToggle>
                <div
                  ...
                  onClick={() => handleEmailDropdownClick()}
                >
                  <span>Email</span>
                  <S.ButtonIdToggle>
                    <S.DropdownIcon visible={isEmailAscendant} />
                  </S.ButtonIdToggle>
                </div>
              </S.ThDisplayToggle>
